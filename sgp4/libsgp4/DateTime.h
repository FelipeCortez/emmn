 ...
 * Modifications Copyright Felipe Cortez <felipecortezfi@gmail.com>
 *
...
// windows.h has macros for min and max...
#ifndef NOMINMAX
#define NOMINMAX
#endif
...
inline int clock_gettime2(int, struct timespec *spec)      //C-file part
